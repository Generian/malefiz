...
import { Lobby, PublicPlayer } from "src/pages"
...
export interface ServerToClientEvents {
  ...
  getGameValidityAndColors: (lobbyValid: boolean, playerColor: PlayerColor, activePlayerColor: PlayerColor, isInPlay: boolean, allPlayers: PublicPlayer[]) => void
